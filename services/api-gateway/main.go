...
func main() {
	...
	mux.HandleFunc("POST /trip/create", enableCORS(handleCreateTrip))
	mux.HandleFunc("POST /driver/register", enableCORS(handleRegisterDriver))
	mux.HandleFunc("POST /driver/unregister", enableCORS(handleUnregisterDriver))
